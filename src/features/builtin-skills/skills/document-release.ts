...
This is a second pass that complements \`/ship\`'s Step 5.5. Read \`.gstack/rules/TODOS-format.md\` (if
...
export const documentReleaseSkill: GstackSkill = {
  name: 'document-release',
  description:
    'Update all project documentation after shipping. Audits README, ARCHITECTURE, CONTRIBUTING, CHANGELOG, and TODOS against the diff — auto-fixes factual changes, polishes CHANGELOG voice, and checks cross-doc consistency.',
  template: transformSkillContent(rawTemplate),
  group: 'deploy',
  originalSkillName: 'gstack-document-release',
