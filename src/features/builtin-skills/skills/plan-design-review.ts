...
Key references: Dieter Rams' 10 Principles, Don Norman's 3 Levels of Design, Nielsen's 10 Heuristics, Gestalt Principles, Ira Glass ("Your taste is why your work disappoints you"), Jony Ive, Joe Gebbia (designing for trust between strangers, storyboarding emotional journeys).
...
* What prior design reviews exist? (check .gstack/analytics/reviews.jsonl)
...
\`\`\`bash
gstack plugin internal: gstack-review-log '{"skill":"plan-design-review","timestamp":"TIMESTAMP","status":"STATUS","initial_score":N,"overall_score":N,"unresolved":N,"decisions_made":N,"commit":"COMMIT"}'
\`\`\`
...
- **Design Review (optional):** Use your judgment. Recommend it for UI/UX changes.
- **Adversarial Review (automatic):** Auto-scales by diff size.
...
After displaying the Review Readiness Dashboard, update the plan file itself so review status is visible to anyone reading the plan. If the plan has a \`## GSTACK REVIEW REPORT\` section, replace it. If not, append to end.
...
**Recommend /plan-eng-review if eng review is not skipped globally** — eng review is the required shipping gate. If this design review added significant interaction specifications, new user flows, or changed the information architecture, emphasize that eng review needs to validate the architectural implications.

**Consider recommending /plan-ceo-review** — but only if this design review revealed fundamental product direction gaps.
...
export const planDesignReviewSkill: GstackSkill = {
  name: 'plan-design-review',
  description:
    "Designer's eye plan review: rate each design dimension 0-10, find gaps, and improve the plan before implementation.",
  template: transformSkillContent(rawTemplate),
  group: 'planning',
  originalSkillName: 'gstack-plan-design-review',
