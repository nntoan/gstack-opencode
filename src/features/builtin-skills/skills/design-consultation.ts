...
ls .gstack/design-docs/*office-hours* 2>/dev/null | head -5
...
and build the browse binary automatically. If unavailable, visual research
will rely on WebSearch and built-in design knowledge instead.
...
If the browse binary is available, visit the top 3-5 sites in the space and capture visual evidence. Open the sites in your browser and analyze what you find.
...
export const designConsultationSkill: GstackSkill = {
  name: 'design-consultation',
  description:
    'Design partner: build a complete design system from scratch. Research the space, propose safe choices and creative risks, generate a preview page, write DESIGN.md.',
  template: transformSkillContent(rawTemplate),
  group: 'review',
  originalSkillName: 'gstack-design-consultation',
