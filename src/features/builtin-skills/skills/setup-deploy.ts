...
export const setupDeploySkill: GstackSkill = {
  name: 'setup-deploy',
  description:
    'Configure deployment settings for /land-and-deploy. Detects platform (Fly.io, Render, Vercel, Netlify), production URL, and health checks — persists to CLAUDE.md for automatic reuse.',
  template: transformSkillContent(rawTemplate),
  group: 'deploy',
  originalSkillName: 'gstack-setup-deploy',
