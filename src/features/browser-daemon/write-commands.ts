...
import { findInstalledBrowsers, importCookies } from './cookie-import-browser.ts';
...
export async function handleWriteCommand(
  ...
  switch (command) {
    ...
    case 'cookie-import': {
      ...
      for (const c of cookies as Record<string, unknown>[]) {
      ...
      await page
        .context()
        .addCookies(cookies as Parameters<ReturnType<typeof page.context>['addCookies']>[0]);
