...
This project is indexed by GitNexus as **gstack-opencode** (1351 symbols, 3851 relationships, 94 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
