...
This project is indexed by GitNexus as **gstack-opencode** (1181 symbols, 3283 relationships, 81 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
