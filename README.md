...
```bash
bunx @nntoan/gstack doctor
```

You're ready when doctor reports no blocking issues and `~/.config/opencode/gstack.jsonc` exists.
...
Default template generated by `bunx @nntoan/gstack install`:
