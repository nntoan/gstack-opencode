...
This project is indexed by GitNexus as **gstack-opencode** (1222 symbols, 3409 relationships, 84 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
